-- ============================================================
-- 030 — RESTORE FULL BACKUP (rate limit kaldirildi)
-- 029 ESKITILDI.
--
-- DEGISIKLIK: SADECE check_rate_limit cagrisi kaldirildi.
--   Sebep: DB'de check_rate_limit(uuid, uuid, text, interval)
--          imzasi yok -> "function does not exist" hatasi.
--   Diger tum logic 029 ile AYNI.
-- ============================================================
...
BEGIN
    ...
    -- check_rate_limit KALDIRILDI (029'dan farki)
    ...
    -- ========================================================
    -- 2) SALES — IDEMPOTENCY KEY + ON CONFLICT
    -- ========================================================
